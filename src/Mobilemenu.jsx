...
export default function Mobilemenu({menu,setmenu,menushow,setMenushow,layer,setlayer}) {
...
const Closemenu=()=>{
  ...
  return (
<div className={`mobile_menu ${menushow ? "show_mobile_menu" : ""}`}>
<button onClick={Closemenu} className="close_btn">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M6 18 18 6M6 6l12 12" />
      ...
      <a href='tel:+917418013888' className='call_btn'>
